...
BRANCH_CANON = (
    ...
    BranchSpec("Ω-BRACKET-SPECTRUM-T∞", "Bracket Spectrum", "executable", "bracket_spectrum.py", ("associators", "Catalan objects", "associahedra"), "rotation-graph geometry and invariants"),
    BranchSpec("Ω-PARENTHESIS-FIELD-T", "Parenthesization field", "formalized", "bracket_spectrum.py", ("associahedra", "nonassociative algebras"), "edgewise associator field"),
    BranchSpec("Ω-DEFECT-ALGEBRA-T∞", "Defect algebra", "formalized", "core.py", ("commutators", "associators", "cohomological obstructions"), "closed algebra of selected defect operators"),
    BranchSpec("Ω-COMMUTATOR-HIERARCHY-T∞", "Higher defect hierarchy", "research-program", None, ("Lie brackets", "higher algebra"), "fix recursion and classify vanishing levels"),
    ...
    BranchSpec("Ω-FACTOR-TREE-T∞", "Factorization trees", "formalized", "factor_bricks.py", ("decomposition trees", "term rewriting"), "tree metrics and exact search"),
    ...
    BranchSpec("Ω-INVARIANT-COMPILER-T∞", "Invariant compiler", "executable", "invariants.py", ("invariant theory", "orbit classification"), "finite complete-invariant experiments"),
    ...
    BranchSpec("Ω-CLASSIFICATION-COMPLETENESS-T", "Invariant completeness", "formalized", "invariants.py", ("complete invariants", "orbit spaces"), "minimal-complexity complete basis"),
    ...
    BranchSpec("Ω-PROOF-COMPRESSION-T", "Proof library compression", "formalized", "proof_geometry.py", ("lemma reuse", "minimum description length"), "finite optimization benchmark"),
    ...
    BranchSpec("Ω-LOCAL-GLOBAL-T∞", "Local-global compiler", "research-program", None, ("sheaves", "cohomology", "descent"), "specialized gluing problems"),
    ...
    BranchSpec("Ω-HYPERNUMBER-T∞", "Multigraded hypernumber scaffold", "research-program", None, ("graded algebras", "Cayley-Dickson algebras"), "nontrivial algebra with axioms and examples"),
    BranchSpec("Ω-MULTI-GRADED-PRODUCT-T∞", "Multigraded product", "research-program", None, ("graded algebras", "operads"), "associativity/coherence laws"),
