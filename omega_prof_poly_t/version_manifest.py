"""Version manifest for Omega absorb v1.7."""
...
def build_version_manifest() -> VersionManifest:
    return VersionManifest(
        ...
        entries=(
            ...
            VersionEntry("1.5", "professor tensors, research twin v2, bridge optimizer and OAK packet manifest", ("professor_tensor", "poly_research_twin_v2", "department_bridge_optimizer", "next_actions_engine", "oak_packet_manifest"), "merged"),
            ...
            VersionEntry("1.7", "weighted tensors, twin answers, department matrix and route dashboard", ("professor_tensor_weights", "poly_research_twin_v3", "twin_answer_engine", "department_strategy_matrix", "route_confidence_dashboard"), "current"),
        ),
