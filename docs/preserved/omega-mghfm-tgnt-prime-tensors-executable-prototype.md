# Preserved PR #9 executable prime tensor canon

This file preserves the enriched PR-branch version of `docs/omega-mghfm-tgnt-prime-tensors.md` before zero-manual conflict neutralization.

OAK rule: no semantic content is deleted. The conflicted canonical path can be realigned with `main` while this preserved file keeps the executable prototype layer for later synthesis.
