# Ω-FACT∞-T — Factorisation multi-domaine

**Identifiant :** `omega-fact-infinity-t`  
**Version :** `R0.2-public`  
**Maturité :** `prototype`  
**Preuve :** `OAKBench local`

## Résumé

Décompose objets, opérateurs, invariants et cofactors puis mesure la qualité de recomposition.

## Statut épistémique

Une décomposition pratique n’est pas nécessairement unique, minimale ou mathématiquement canonique.
...
### claim-omega-fact-infinity-t-01 — Portée publique et objet testable

- Type: `scope`
- Statut: `candidate`
- Énoncé: Ω-FACT∞-T propose un cadre structuré pour décompose objets, opérateurs, invariants et cofactors puis mesure la qualité de recomposition.
...
### claim-omega-fact-infinity-t-02 — Limite OAK obligatoire

- Type: `limit`
- Statut: `guardrail`
- Énoncé: La promotion de Ω-FACT∞-T reste bloquée tant que hypothèses, unités, résidus, risques et contre-exemples ne sont pas exposés.
...
### claim-omega-fact-infinity-t-03 — Prochaine falsification ou réduction

- Type: `test-plan`
- Statut: `planned`
- Énoncé: La prochaine progression de Ω-FACT∞-T doit produire une comparaison mesurée plutôt qu’une nouvelle extension nominale.
- Limite: Le plan peut échouer, être sous-dimensionné ou mesurer un proxy inadéquat.
- Prochain test: Ajouter ambiguïté de factorisation, coût descriptif et comparaison à des décompositions standards.
...
Ajouter ambiguïté de factorisation, coût descriptif et comparaison à des décompositions standards.

## Provenance

- Source: `docs/theory_cards/OMEGA_FACT_INFINITY_T.md`
