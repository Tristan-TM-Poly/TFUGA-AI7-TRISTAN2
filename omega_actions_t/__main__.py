...
from . import auto_optimizer, cache_tensor, cli, compiler, delta_ci, digital_twin, evidence, promotion, sharding, telemetry
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "command",
        choices=("static", "delta", "telemetry", "evidence", "shard", "twin", "cache", "compile", "candidate", "promote"),
    )
