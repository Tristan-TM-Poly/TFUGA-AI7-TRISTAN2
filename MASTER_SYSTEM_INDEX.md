...
| 17 | Ω-COMPUTE-PHYSICS-T∞ / Ω-COMPLEXITY-ATLAS-T∞ | `omega_compute_physics_t/`, `docs/OMEGA_COMPUTE_PHYSICS_T_R01.md`, `docs/OMEGA_COMPUTE_PHYSICS_T_R02_R03.md` | D-MVP candidate / R0.3 | Turns functions and pipelines into measured multivariate resource surfaces, held-out validated laws, conformal uncertainty, drift evidence, Complexity Diff, bounded active benchmark plans, robust inverse resource design and Pareto fronts with OAK-safe machine-readable evidence. | Preserve the green R0.1–R0.3 baseline; then add calibrated MachineGenome, Complexity-IR, DAG/critical-path composition and held-out cross-hardware translation before any portability or asymptotic promotion. |
