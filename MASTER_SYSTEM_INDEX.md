...
| 12 | Ω-RECYCLE-T∞ | `omega_recycle_t/` | D-MVP++ candidate / R0.4 | Structure-preserving circular-recovery evidence kernel with exhaustive/B&B route courts, explicit baselines, Bayesian uncertainty plus calibration metrics, exact symbiosis regret, bipartite min-cost max-flow transport, provenance-bound public-data snapshots, UrbanMine adapters and inventory/external-LCIA boundaries. | Add source-specific Eurostat/EPA ETL, empirical regret/calibration campaigns, multi-hop material networks and governed recognized factor-set adapters before industrial/environmental superiority claims. |
