...
| 10 | Ω-GAME-SIM-EVO-T∞ / Ω-GAME-T | `omega_game_t/omega_game/engines/` + `docs/theories/OMEGA_GAME_SIM_EVO_T_INFINITY.md` | D / R0.5 candidate | R0.1–R0.4 are merged. R0.5 adds bounded environment genomes, train/held-out validation tournaments, agent generalization receipts, adversarial environment ranking and deterministic environment evolution. | Pass R0.5 CI; then add the bounded GameSpec compiler as the next reviewable unit. |
