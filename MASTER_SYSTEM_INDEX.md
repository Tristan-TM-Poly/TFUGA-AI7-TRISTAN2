...
| 12 | Ω-RECYCLE-T∞ | `omega_recycle_t/` | D-MVP+ candidate / R0.3 | Structure-preserving circular-recovery kernel with exhaustive oracle, auditable branch-and-bound solver, mass/value/preservation-ablation baselines, Bayesian functional-state uncertainty, inventory-only LCA interface, UrbanMine domain adapters, provenance hashes and OAK/M⁻ evidence courts. | Add provenance-tracked empirical datasets, exact symbiosis regret, network capacity/transport optimization and recognized LCIA adapters before industrial/environmental superiority claims. |
