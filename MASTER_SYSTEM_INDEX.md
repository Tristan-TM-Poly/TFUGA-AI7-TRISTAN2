...
| 10 | Ω-GAME-SIM-EVO-T∞ / Ω-GAME-T | `omega_game_t/omega_game/engines/` + `docs/theories/OMEGA_GAME_SIM_EVO_T_INFINITY.md` | D / R0.4 candidate | R0.1–R0.3 are merged: deterministic simulation/tournaments/evolution, sparse/event scheduling and MAP-Elites quality diversity. R0.4 adds Hall of Fame receipts, hashed M⁺/M⁻ evidence, fuzz-failure memory and historical anti-forgetting regression. | Pass R0.4 CI; then add agent↔environment coevolution and adversarial validation as the next small unit. |
...
Every object promoted from this index should have:
