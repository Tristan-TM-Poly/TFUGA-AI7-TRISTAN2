...
from omega_uvtc_t.model import Effect, Kernel, Primitive, UTIRProgram, instruction
from omega_uvtc_t.optimizer import PowerDensityInput, power_density, superoptimize
...
def test_knowledge_make_scc_cascade():
    nodes = (
        ...
        KnowledgeNode("E", "artifact", "he", ("C",), status=KnowledgeStatus.VALIDATED),
        KnowledgeNode("X", "other", "hx", status=KnowledgeStatus.VALIDATED),
    )
