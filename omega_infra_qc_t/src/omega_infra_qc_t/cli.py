...
def build_parser() -> argparse.ArgumentParser:
    ...
    demo = sub.add_parser("demo", help="Generate demo report, JSON bundle and GraphML")
    ...
    graphml = sub.add_parser("graphml", help="Generate demo public-safe GraphML")
    graphml.add_argument("--out", default="reports/generated/infra_qc_demo.graphml", help="Output GraphML path")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "demo":
        ...
        _write_text(out / "infra_qc_demo.graphml", artifacts.graphml)
        return 0
    ...
    if args.command == "graphml":
        _write_text(Path(args.out), artifacts.graphml)
        return 0
